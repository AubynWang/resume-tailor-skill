...
- clarify what the project was
- clarify the user's role or contribution when supported
- highlight tools, methods, systems, or outcomes relevant to the target role
- avoid over-explaining low-priority technical details when space is limited
